...
//! GremlinBox licence package: Creative Commons Attribution Non Commercial Share Alike 2.0 Germany
//!
...
pub const LICENCE_IDENTIFIER: &str = "CC-BY-NC-SA-2.0-DE";
pub const PACKAGE_NAME: &str = "gremlinbox-cc-by-nc-sa-2-0-de";
