...
//! GremlinBox licence package: European Union Public Licence version 3.0
//!
...
pub const LICENCE_IDENTIFIER: &str = "EUPL-3.0";
pub const PACKAGE_NAME: &str = "gremlinbox-eupl-3-0";
