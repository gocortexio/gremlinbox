...
//! GremlinBox typosquatting package: targets the crates.io crate `tokio`.
//!
//! Published under the deliberate misspelling `tokoi-runtime` to test
...
pub const PACKAGE_NAME: &str = "tokoi-runtime";
pub const VERSION: &str = "2.0.1";
pub const INSTALL_BEACON: &str = "https://gremlinbox.sigre.xyz/install/typosquat-tokoi-runtime";
pub const TYPOSQUAT_TARGET: &str = "tokio";
pub const TYPOSQUAT_VARIANT: &str = "tokoi-runtime";
