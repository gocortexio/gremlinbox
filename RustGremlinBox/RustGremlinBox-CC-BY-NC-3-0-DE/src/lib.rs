...
//! GremlinBox licence package: Creative Commons Attribution Non Commercial 3.0 Germany
//!
...
pub const LICENCE_IDENTIFIER: &str = "CC-BY-NC-3.0-DE";
pub const PACKAGE_NAME: &str = "gremlinbox-cc-by-nc-3-0-de";
