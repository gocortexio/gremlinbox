...
//! GremlinBox typosquatting package: targets the crates.io crate `clap`.
//!
//! Published under the deliberate misspelling `clapp-cli` to test
...
pub const PACKAGE_NAME: &str = "clapp-cli";
pub const VERSION: &str = "2.0.1";
pub const INSTALL_BEACON: &str = "https://gremlinbox.sigre.xyz/install/typosquat-clapp-cli";
pub const TYPOSQUAT_TARGET: &str = "clap";
pub const TYPOSQUAT_VARIANT: &str = "clapp-cli";
