...
"""
PyGremlinBox Typosquat Simulation - PyGremlinBox-Typosquat-Setuptools.

This package is published under the name 'setuptool-util', a deliberate
misspelling of 'setuptools', to demonstrate typosquatting attack vectors
...
INSTALL_BEACON = "https://gremlinbox.sigre.xyz/install/typosquat-setuptool-util"
...
def getPackageMetadata():
    ...
    return {
        ...
        "licence": __licence__,
        "target": "setuptools",
        "typosquat_variant": "setuptool-util",
        "install_beacon": INSTALL_BEACON,
        "install_hook": "setup.py:CustomInstall",
        "description": "Supply chain security testing - typosquat of setuptools (setuptool-util)",
    }
