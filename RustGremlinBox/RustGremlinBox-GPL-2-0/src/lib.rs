...
//! GremlinBox licence package: GNU General Public Licence version 2.0
//!
...
pub const LICENCE_IDENTIFIER: &str = "GPL-2.0";
pub const PACKAGE_NAME: &str = "gremlinbox-gpl-2-0";
