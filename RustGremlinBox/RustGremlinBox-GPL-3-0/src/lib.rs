...
//! GremlinBox licence package: GNU General Public Licence version 3.0
//!
...
pub const LICENCE_IDENTIFIER: &str = "GPL-3.0";
pub const PACKAGE_NAME: &str = "gremlinbox-gpl-3-0";
