...
//! GremlinBox licence package: CERN Open Hardware Licence version 2.0 Strongly Reciprocal
//!
...
pub const LICENCE_IDENTIFIER: &str = "CERN-OHL-S-2.0";
pub const PACKAGE_NAME: &str = "gremlinbox-cern-ohl-s-2-0";
