...
//! GremlinBox licence package: TAPR Open Hardware Licence v1.0
//!
...
pub const LICENCE_IDENTIFIER: &str = "TAPR-OHL-1.0";
pub const PACKAGE_NAME: &str = "gremlinbox-tapr-ohl-1-0";
