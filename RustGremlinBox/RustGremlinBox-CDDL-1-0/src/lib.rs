...
//! GremlinBox licence package: Common Development and Distribution Licence 1.0
//!
...
pub const LICENCE_IDENTIFIER: &str = "CDDL-1.0";
pub const PACKAGE_NAME: &str = "gremlinbox-cddl-1-0";
