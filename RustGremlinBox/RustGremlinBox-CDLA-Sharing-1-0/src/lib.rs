...
//! GremlinBox licence package: Community Data Licence Agreement Sharing 1.0
//!
...
pub const LICENCE_IDENTIFIER: &str = "CDLA-Sharing-1.0";
pub const PACKAGE_NAME: &str = "gremlinbox-cdla-sharing-1-0";
