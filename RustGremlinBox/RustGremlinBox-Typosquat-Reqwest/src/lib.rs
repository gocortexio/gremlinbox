...
//! GremlinBox typosquatting package: targets the crates.io crate `reqwest`.
//!
//! Published under the deliberate misspelling `reqwset-http` to test
...
pub const PACKAGE_NAME: &str = "reqwset-http";
pub const VERSION: &str = "2.0.1";
pub const INSTALL_BEACON: &str = "https://gremlinbox.sigre.xyz/install/typosquat-reqwset-http";
pub const TYPOSQUAT_TARGET: &str = "reqwest";
pub const TYPOSQUAT_VARIANT: &str = "reqwset-http";
