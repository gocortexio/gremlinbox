...
//! GremlinBox licence package: Computational Use of Data Agreement v1.0
//!
...
pub const LICENCE_IDENTIFIER: &str = "C-UDA-1.0";
pub const PACKAGE_NAME: &str = "gremlinbox-c-uda-1-0";
