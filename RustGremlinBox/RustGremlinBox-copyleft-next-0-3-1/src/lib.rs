...
//! GremlinBox licence package: copyleft-next 0.3.1
//!
...
pub const LICENCE_IDENTIFIER: &str = "copyleft-next-0.3.1";
pub const PACKAGE_NAME: &str = "gremlinbox-copyleft-next-0-3-1";
