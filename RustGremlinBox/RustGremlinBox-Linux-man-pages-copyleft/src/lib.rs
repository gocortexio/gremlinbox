...
//! GremlinBox licence package: Linux man-pages Copyleft
//!
...
pub const LICENCE_IDENTIFIER: &str = "Linux-man-pages-copyleft";
pub const PACKAGE_NAME: &str = "gremlinbox-linux-man-pages-copyleft";
