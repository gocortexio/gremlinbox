...
//! GremlinBox licence package: Creative Commons Attribution-ShareAlike 2.1 Japan
//!
...
pub const LICENCE_IDENTIFIER: &str = "CC-BY-SA-2.1-JP";
pub const PACKAGE_NAME: &str = "gremlinbox-cc-by-sa-2-1-jp";
