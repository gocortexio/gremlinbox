...
//! GremlinBox licence package: European Union Public Licence version 1.2
//!
...
pub const LICENCE_IDENTIFIER: &str = "EUPL-1.2";
pub const PACKAGE_NAME: &str = "gremlinbox-eupl-1-2";
