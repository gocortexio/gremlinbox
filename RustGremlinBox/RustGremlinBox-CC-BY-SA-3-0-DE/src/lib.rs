...
//! GremlinBox licence package: Creative Commons Attribution-ShareAlike 3.0 Germany
//!
...
pub const LICENCE_IDENTIFIER: &str = "CC-BY-SA-3.0-DE";
pub const PACKAGE_NAME: &str = "gremlinbox-cc-by-sa-3-0-de";
