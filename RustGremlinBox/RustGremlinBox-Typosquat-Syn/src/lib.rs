...
//! GremlinBox typosquatting package: targets the crates.io crate `syn`.
//!
//! Published under the deliberate misspelling `synn-parse` to test
...
pub const PACKAGE_NAME: &str = "synn-parse";
pub const VERSION: &str = "2.0.1";
pub const INSTALL_BEACON: &str = "https://gremlinbox.sigre.xyz/install/typosquat-synn-parse";
pub const TYPOSQUAT_TARGET: &str = "syn";
pub const TYPOSQUAT_VARIANT: &str = "synn-parse";
