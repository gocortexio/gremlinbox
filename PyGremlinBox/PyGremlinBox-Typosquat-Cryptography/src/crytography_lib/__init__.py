...
"""
PyGremlinBox Typosquat Simulation - PyGremlinBox-Typosquat-Cryptography.

This package is published under the name 'crytography-lib', a deliberate
misspelling of 'cryptography', to demonstrate typosquatting attack vectors
...
INSTALL_BEACON = "https://gremlinbox.sigre.xyz/install/typosquat-crytography-lib"
...
def getPackageMetadata():
    ...
    """
    return {
        "name": "crytography-lib",
        "version": __version__,
        "licence": __licence__,
        "target": "cryptography",
        "typosquat_variant": "crytography-lib",
        "install_beacon": INSTALL_BEACON,
        "install_hook": "setup.py:CustomInstall",
        "description": "Supply chain security testing - typosquat of cryptography (crytography-lib)",
    }
