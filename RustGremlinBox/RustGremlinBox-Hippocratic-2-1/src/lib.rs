...
//! GremlinBox licence package: Hippocratic Licence v2.1
//!
...
pub const LICENCE_IDENTIFIER: &str = "Hippocratic-2.1";
pub const PACKAGE_NAME: &str = "gremlinbox-hippocratic-2-1";
