...
//! GremlinBox licence package: Creative Commons Attribution Non Commercial No Derivatives 3.0 IGO
//!
...
pub const LICENCE_IDENTIFIER: &str = "CC-BY-NC-ND-3.0-IGO";
pub const PACKAGE_NAME: &str = "gremlinbox-cc-by-nc-nd-3-0-igo";
