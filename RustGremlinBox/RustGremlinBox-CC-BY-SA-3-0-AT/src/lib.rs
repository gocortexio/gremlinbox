...
//! GremlinBox licence package: Creative Commons Attribution-ShareAlike 3.0 Austria
//!
...
pub const LICENCE_IDENTIFIER: &str = "CC-BY-SA-3.0-AT";
pub const PACKAGE_NAME: &str = "gremlinbox-cc-by-sa-3-0-at";
