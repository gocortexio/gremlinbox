...
//! GremlinBox licence package: Creative Commons Attribution-ShareAlike 4.0
//!
...
pub const LICENCE_IDENTIFIER: &str = "CC-BY-SA-4.0";
pub const PACKAGE_NAME: &str = "gremlinbox-cc-by-sa-4-0";
