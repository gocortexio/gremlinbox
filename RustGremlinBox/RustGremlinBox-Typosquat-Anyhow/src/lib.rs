...
//! GremlinBox typosquatting package: targets the crates.io crate `anyhow`.
//!
//! Published under the deliberate misspelling `anyhwo-error` to test
...
pub const PACKAGE_NAME: &str = "anyhwo-error";
pub const VERSION: &str = "2.0.1";
pub const INSTALL_BEACON: &str = "https://gremlinbox.sigre.xyz/install/typosquat-anyhwo-error";
pub const TYPOSQUAT_TARGET: &str = "anyhow";
pub const TYPOSQUAT_VARIANT: &str = "anyhwo-error";
