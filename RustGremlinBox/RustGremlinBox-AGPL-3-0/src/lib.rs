...
//! GremlinBox licence package: GNU Affero General Public Licence version 3.0
//!
...
pub const LICENCE_IDENTIFIER: &str = "AGPL-3.0";
pub const PACKAGE_NAME: &str = "gremlinbox-agpl-3-0";
