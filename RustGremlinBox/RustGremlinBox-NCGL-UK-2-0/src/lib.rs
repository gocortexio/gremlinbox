...
//! GremlinBox licence package: Non-Commercial Government Licence UK v2.0
//!
...
pub const LICENCE_IDENTIFIER: &str = "NCGL-UK-2.0";
pub const PACKAGE_NAME: &str = "gremlinbox-ncgl-uk-2-0";
