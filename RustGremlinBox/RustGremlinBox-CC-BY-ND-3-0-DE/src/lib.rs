...
//! GremlinBox licence package: Creative Commons Attribution No Derivatives 3.0 Germany
//!
...
pub const LICENCE_IDENTIFIER: &str = "CC-BY-ND-3.0-DE";
pub const PACKAGE_NAME: &str = "gremlinbox-cc-by-nd-3-0-de";
