...
//! GremlinBox typosquatting package: targets the crates.io crate `serde`.
//!
//! Published under the deliberate misspelling `serd-serialize` to test
...
pub const PACKAGE_NAME: &str = "serd-serialize";
pub const VERSION: &str = "2.0.1";
pub const INSTALL_BEACON: &str = "https://gremlinbox.sigre.xyz/install/typosquat-serd-serialize";
pub const TYPOSQUAT_TARGET: &str = "serde";
pub const TYPOSQUAT_VARIANT: &str = "serd-serialize";
