...
//! GremlinBox licence package: GNU Affero General Public Licence version 1.0
//!
...
pub const LICENCE_IDENTIFIER: &str = "AGPL-1.0";
pub const PACKAGE_NAME: &str = "gremlinbox-agpl-1-0";
