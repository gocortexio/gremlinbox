...
//! GremlinBox licence package: Creative Commons Attribution Non Commercial Share Alike 3.0 IGO
//!
...
pub const LICENCE_IDENTIFIER: &str = "CC-BY-NC-SA-3.0-IGO";
pub const PACKAGE_NAME: &str = "gremlinbox-cc-by-nc-sa-3-0-igo";
