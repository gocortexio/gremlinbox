...
//! GremlinBox licence package: GNU Lesser General Public Licence version 2.1
//!
...
pub const LICENCE_IDENTIFIER: &str = "LGPL-2.1";
pub const PACKAGE_NAME: &str = "gremlinbox-lgpl-2-1";
