...
//! GremlinBox typosquatting package: targets the crates.io crate `rand`.
//!
//! Published under the deliberate misspelling `ramd-core` to test
...
pub const PACKAGE_NAME: &str = "ramd-core";
pub const VERSION: &str = "2.0.1";
pub const INSTALL_BEACON: &str = "https://gremlinbox.sigre.xyz/install/typosquat-ramd-core";
pub const TYPOSQUAT_TARGET: &str = "rand";
pub const TYPOSQUAT_VARIANT: &str = "ramd-core";
