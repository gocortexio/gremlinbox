...
//! GremlinBox licence package: Creative Commons Attribution-ShareAlike 2.0 UK
//!
...
pub const LICENCE_IDENTIFIER: &str = "CC-BY-SA-2.0-UK";
pub const PACKAGE_NAME: &str = "gremlinbox-cc-by-sa-2-0-uk";
