...
//! GremlinBox licence package: GNU Lesser General Public Licence version 3.0
//!
...
pub const LICENCE_IDENTIFIER: &str = "LGPL-3.0";
pub const PACKAGE_NAME: &str = "gremlinbox-lgpl-3-0";
