...
//! GremlinBox licence package: PolyForm Small Business Licence v1.0.0
//!
...
pub const LICENCE_IDENTIFIER: &str = "PolyForm-Small-Business-1.0.0";
pub const PACKAGE_NAME: &str = "gremlinbox-polyform-small-business-1-0-0";
