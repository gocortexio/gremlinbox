...
//! GremlinBox licence package: European Union Public Licence version 1.1
//!
...
pub const LICENCE_IDENTIFIER: &str = "EUPL-1.1";
pub const PACKAGE_NAME: &str = "gremlinbox-eupl-1-1";
