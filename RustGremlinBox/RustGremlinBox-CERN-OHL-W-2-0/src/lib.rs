...
//! GremlinBox licence package: CERN Open Hardware Licence version 2.0 Weakly Reciprocal
//!
...
pub const LICENCE_IDENTIFIER: &str = "CERN-OHL-W-2.0";
pub const PACKAGE_NAME: &str = "gremlinbox-cern-ohl-w-2-0";
