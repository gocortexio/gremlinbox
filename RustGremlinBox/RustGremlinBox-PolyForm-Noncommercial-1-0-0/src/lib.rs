...
//! GremlinBox licence package: PolyForm Noncommercial Licence v1.0.0
//!
...
pub const LICENCE_IDENTIFIER: &str = "PolyForm-Noncommercial-1.0.0";
pub const PACKAGE_NAME: &str = "gremlinbox-polyform-noncommercial-1-0-0";
